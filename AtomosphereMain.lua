...
function Atomos:NewTab(Name) --[[AtomosTab› ]]
	...
	function ElementsList:Slider(str, min, max, def, callback)
		...
		Container.Size = UDim2.new(0, 30, 0, 28)
		...
		ValueBG.Position = UDim2.new(-0.00774456561, 0, 0, 0)
		ValueBG.Size = UDim2.new(0, 30, 0, 25)
		ValueBG.ZIndex = -1
		...
		SliderText.Position = UDim2.new(0, 0, 0, 2)
		SliderText.Size = UDim2.new(0, 30, 0, 12)
		SliderText.ZIndex = 0
